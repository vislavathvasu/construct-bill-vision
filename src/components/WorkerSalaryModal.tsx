              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
                    <div className="text-gray-800 font-semibold">Not Marked</div>
                    <div className="text-2xl font-bold text-gray-600">{attendanceData.notMarked}</div>
                  </div>
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    <div className="text-blue-800 font-semibold">Total Days</div>
                    <div className="text-2xl font-bold text-blue-600">{attendanceData.totalDaysInMonth}</div>
                  </div>
                </div>
              </div>
